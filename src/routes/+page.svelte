...
<div class="w-full min-w-0 py-2 sm:py-3 md:py-0">
	<div
		class="mx-auto grid w-full max-w-[1800px] grid-cols-1 gap-3 pb-30 sm:gap-4 md:grid-cols-2 xl:grid-cols-3 xl:gap-6 2xl:pb-8"
	>
		<ClubOverviewCard
